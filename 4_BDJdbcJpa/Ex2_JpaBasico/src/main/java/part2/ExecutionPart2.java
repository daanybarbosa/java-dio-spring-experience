...
public class ExecutionPart2 {
    public static void main(String[] args) {
        ...
        Aluno alunoParaAdicionar2 = new Aluno("João", 40, estadoParaAdicionar);
        ...
        // 3 - Resgatar instâncias no banco de dados - apenas leitura do banco
        Estado estadoEncontrado = entityManager.find(Estado.class, 1); //buscando no banco o dado que possui o id 1
        ...
        alunoEncontrado.setNome("Karam"); //alterar o dado nome
        ...
        entityManager.remove(alunoEncontrado); //remover o dado do banco de dados
